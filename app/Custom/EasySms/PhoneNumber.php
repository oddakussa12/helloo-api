...
class PhoneNumber implements PhoneNumberInterface
{
     ...
     * @return int
     */
    public function getHyphenPrefixedNumber()
    {
        return '-'.$this->number;
    }
     ...
     * @return string
     */
    public function getFormatUniversalNumber()
    {
        return $this->getPrefixedIDDCode().$this->getHyphenPrefixedNumber();
    }
     ...
     * @return string
     */
    public function getUniversalFormatNumber()
    {
        return $this->getPrefixedIDDCode('+').$this->number;
    }
