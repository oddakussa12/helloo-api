...
namespace App\Custom\Redis\Connections;
...
class PhpRedisConnection extends Connection
{
     ...
     * @return array|mixed
     */
    public function zrange($key, $min, $max, $options = [])
    {
        if (isset($options['withscores'])) {
            $options = boolval($options['withscores']);
        }else{
            $options = boolval($options);
        }
...
//    }
    ...
    public function rpush($key , ...$value)
    {
        ...
        return call_user_func_array(array(parent::class, 'rpush'), array_merge(array($key) , $value));
    }
