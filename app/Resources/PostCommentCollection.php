...
class PostCommentCollection extends Resource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'comment_content' => strip_tags(empty($this->comment_content)?optional($this->translate(config('translatable.translate_default_lang')))->comment_content:$this->comment_content),
            'comment_default_locale' => $this->comment_default_locale,
            'comment_default_content' => optional($this->translate($this->comment_default_locale))->comment_content,
            ...
            'children' => $this->when($request->children==true , self::collection($this->children)),
        ];
    }
}