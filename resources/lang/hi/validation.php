...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            'wrong_format' => 'कृपया एक मान्य फ़ोन नंबर का उपयोग करें',
            'unique' => 'यह फोन नंबर पंजीकृत किया गया है।',
        ],
        'name' => [
            'regex' => 'कृपया अक्षरों और संख्याओं का उपयोग करें, जैसे। abcdef123',
            'unique' => 'यह खाता पंजीकृत हो गया है, कृपया लॉग इन करें!',
        ],
        'email' => [
            'unique' => 'यह मेलबॉक्स पंजीकृत हो गया है, कृपया लॉग इन करें!',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'post_content'          => 'सामग्री पोस्ट करें',
        'tag_slug'              => 'पोस्ट टैग',
        'comment_content'       => 'टिप्पणियाँ',
        'user_birthday'         => 'जन्मदिन',
    ],
];
