...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'phone' => [
            'wrong_format' => 'Пожалуйста, используйте правильный номер телефона',
            'unique' => 'Этот номер телефона был зарегистрирован.',
        ],
        'name' => [
            'regex' => 'Пожалуйста, используйте буквы и цифры, например. abcdef123',
            'unique' => 'Эта учетная запись была зарегистрирована, пожалуйста, войдите!',
        ],
        'email' => [
            'unique' => 'Этот почтовый ящик был зарегистрирован, пожалуйста, войдите!',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'post_content'          => 'Разместить контент',
        'tag_slug'              => 'Отправить тег',
        'comment_content'       => 'Комментарии',
